        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Gestion des attributions</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Gestion des attributions</li>
                    </ol>
                </div>
            </div>
                                ...
                                <option value="">--Select salle--</option>
                                    ...
                                    ?>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label">type capacité de salle</label>
                                                <div class="col-sm-9">
