...
<div class="popup popup--icon -question js_question-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>
      <a href="del_subject.php?id=<?php echo $_GET['id']; ?>" class="button button--success" data-for="js_success-popup">Oui</a>
      <a href="view_subject.php" class="button button--error" data-for="js_success-popup">Non</a>
    </p>
  </div>
</div>
<?php } ?>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary"> Voir Les Modules</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Page</a></li>
                        <li class="breadcrumb-item active">voir Les Modules</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="container-fluid">
                 ...
                 <div class="card">
                            ...
                            <a href="add_subject.php"><button class="btn " style="background-color: #135297;color: white">Ajouter Module</button></a>
                          <?php } } ?>
