                ...
                <div class="row">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                   <select name="gender" class="form-control" required>
                                                     <option value="Male"  <?php if($gender=="Male"){ echo "selected";}?>>Masculin</option>
                                                      <option value="Female" <?php if($gender=="Female"){ echo "selected";}?>>Feminin</option>
                                                   </select>
                                                </div>
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                  <image class="profile-img" src="uploadImage/Profile/<?=$image?>" style="height:50%;width:60%;">
                  <input type="hidden" value="<?=$image?>" name="old_image">
                          <input type="file" class="form-control" name="image">
                                        ...
                                        <button type="submit" name="btn_update" class="btn btn-primary btn-flat m-b-30 m-t-30">Modifier</button>
                                    </form>
                                </div>
                            </div>
                        </div>
