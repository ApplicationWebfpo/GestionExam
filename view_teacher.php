...
<div class="popup popup--icon -question js_question-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>
      <a href="del_teacher.php?id=<?php echo $_GET['id']; ?>" class="button button--success" data-for="js_success-popup">Oui</a>
      <a href="view_teacher.php" class="button button--error" data-for="js_success-popup">Non</a>
    </p>
  </div>
</div>
<?php } ?>
        ...
        <div class="page-wrapper" style="color: #135297">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 style="color: #135297"> Voir Enseignant</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Voir Enseignant</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="container-fluid" style="color: #135297">
                 ...
                 <div class="card">
                            ...
                            <a href="add_teacher.php"><button style="background-color: #135297;color: white" class="btn ">Ajouter Professeur</button></a>
                          <?php } } ?>
                                <div class="table-responsive m-t-40">
                                  <!-- id="myTable" -->
                                    <table id="myTable" class="table table-bordered table-striped" style="color: #135297">
                                        <thead style="color: #135297">
                                            ...
                                            <th>Matricule</th>
                                                ...
                                                <th  style="color: #135297">Module</th>
                                                <th  style="color: #135297">Email</th>
                                                <!-- <th  style="color: #135297">Genre</th> -->
                                                <th  style="color: #135297">Date de naissance</th>
                                                <th  style="color: #135297">Numéro de contact</th>
                                                <th  style="color: #135297">Adresse</th>
