...
<div class="popup popup--icon -question js_question-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>
      <a href="del_user.php?id=<?php echo $_GET['id']; ?>" class="button button--success" data-for="js_success-popup">Oui</a>
      <a href="view_user.php" class="button button--error" data-for="js_success-popup">Non</a>
    </p>
  </div>
</div>
<?php } ?>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">   Voir les utilisateurs</h3> </div>
            ...
            <div class="container-fluid">
                 ...
                 <div class="card">
                            ...
                            <a href="add_user.php"><button class="btn btn-primary">Ajouter les utilisateurs</button></a>
                          <?php } } ?>
